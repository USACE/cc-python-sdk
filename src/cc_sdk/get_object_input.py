...
class GetObjectInput:
    ...
    - source_store_type : StoreType
        ...
        (does not include file name or extension and must not have a trailing slash). readonly
    - source_root_path : string
        The source path of the object on the data store
        (does not include file name or extension and must not include a trailing slash). readonly
